(function() {
  ...
  _.last = function(array, n) {
    ...
    return n === undefined ? array[length-1] : array.slice(length-n < 0 ? 0:length-n, length);
  };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(allElements, item){
      if(!allElements){
        return false;
      }
  ...
  _.extend = function(obj) {
    _.each(arguments, function(listOfObjects){
      _.each(listOfObjects, function(item, key){
          obj[key] = item;
      });
    });
